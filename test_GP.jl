...
best_expr_rs, best_mae_rs, mae_history_rs = genetic_programming(population_size, x_values, y_values, evaluation, depth)
...
p2 = plot(mae_history_rs, label="Genetic Programming",lw=3)
